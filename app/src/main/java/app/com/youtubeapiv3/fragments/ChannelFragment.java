...
public class ChannelFragment extends Fragment {
    private static String GOOGLE_YOUTUBE_API_KEY = "AIzaSyAiQSTNr707AAI8ahakyEYj1x7i5Jxu604";//here you should use your api key for testing purpose you can use this api also
